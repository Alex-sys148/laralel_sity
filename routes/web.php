...
Route::get('/contact/submit', 'ContactController@submit')->name('contact-form');
...
Route::get('/contact/all/{id}/up/date', 'ContactController@updateMessageSubmit')->name('contact-update-submit');
